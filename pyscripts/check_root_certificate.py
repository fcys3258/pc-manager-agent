TOOL_DEF = {"name": "check_root_certificate", "description": "检查根证书", "input_schema": {"type": "object", "properties": {"common_name": {"type": "string"}, "thumbprint": {"type": "string"}, "store": {"type": "string"}, "location": {"type": "string"}}, "required": []}}
