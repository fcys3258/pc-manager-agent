TOOL_DEF = {"name": "execute_cleanup_items", "description": "执行清理操作", "input_schema": {"type": "object", "properties": {"cleanup_ids": {"type": "array", "items": {"type": "string", "enum": ["SYSTEM_TEMP", "USER_TEMP", "RECYCLE_BIN", "CRASH_DUMPS", "WECHAT_CACHE", "WXWORK_CACHE", "BROWSER_CACHE", "WINDOWS_UPDATE_CACHE"]}}}, "required": ["cleanup_ids"]}}
