TOOL_DEF = {"name": "test_connectivity", "description": "测试网络连接（ping/端口测试）", "input_schema": {"type": "object", "properties": {"mode": {"type": "string", "enum": ["internet", "intranet", "custom"]}, "target": {"type": "string"}, "port": {"type": "integer"}, "dns_server": {"type": "string"}}, "required": []}}
