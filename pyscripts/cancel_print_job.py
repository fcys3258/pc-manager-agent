TOOL_DEF = {"name": "cancel_print_job", "description": "取消打印任务", "input_schema": {"type": "object", "properties": {"printer_name": {"type": "string"}, "job_id": {"anyOf": [{"type": "integer"}, {"type": "string"}]}}, "required": ["printer_name", "job_id"]}}
