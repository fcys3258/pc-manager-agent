TOOL_DEF = {"name": "get_installed_software", "description": "获取已安装软件列表", "input_schema": {"type": "object", "properties": {"limit": {"type": "integer"}, "sort_by": {"type": "string", "enum": ["name", "install_date", "publisher"]}, "name_filter": {"type": "string"}}, "required": []}}
