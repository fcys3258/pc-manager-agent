TOOL_DEF = {"name": "get_running_processes", "description": "获取运行中的进程列表", "input_schema": {"type": "object", "properties": {"limit": {"type": "integer"}, "sort_by": {"type": "string", "enum": ["cpu", "memory", "io"]}, "include_username": {"type": "boolean"}}, "required": []}}
