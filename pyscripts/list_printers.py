TOOL_DEF = {"name": "list_printers", "description": "列出所有打印机", "input_schema": {"type": "object", "properties": {"limit": {"type": "integer"}, "sort_by": {"type": "string", "enum": ["name", "status", "driver_name"]}}, "required": []}}
