TOOL_DEF = {"name": "trace_network_route", "description": "追踪网络路由（traceroute）", "input_schema": {"type": "object", "properties": {"target": {"type": "string"}, "max_hops": {"type": "integer"}, "timeout_ms": {"type": "integer"}}, "required": ["target"]}}
