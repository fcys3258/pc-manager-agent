TOOL_DEF = {"name": "list_large_files", "description": "列出大文件", "input_schema": {"type": "object", "properties": {"path": {"type": "string"}, "limit": {"type": "integer"}, "max_depth": {"type": "integer"}}, "required": ["path"]}}
