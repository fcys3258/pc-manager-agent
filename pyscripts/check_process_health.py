TOOL_DEF = {"name": "check_process_health", "description": "检查进程健康状态（崩溃、重启历史）", "input_schema": {"type": "object", "properties": {"process_name": {"type": "string"}, "time_range_hours": {"type": "integer"}, "limit": {"type": "integer"}}, "required": ["process_name"]}}
