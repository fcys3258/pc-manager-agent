TOOL_DEF = {"name": "get_pnp_device_list", "description": "获取即插即用设备列表", "input_schema": {"type": "object", "properties": {"problem_only": {"type": "boolean"}, "limit": {"type": "integer"}, "sort_by": {"type": "string", "enum": ["friendly_name", "class", "status", "problem_code"]}}, "required": []}}
