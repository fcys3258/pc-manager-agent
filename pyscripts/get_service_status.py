TOOL_DEF = {"name": "get_service_status", "description": "获取Windows服务状态", "input_schema": {"type": "object", "properties": {"service_names": {"type": "array", "items": {"type": "string"}}, "limit": {"type": "integer"}, "sort_by": {"type": "string", "enum": ["name", "status", "display_name"]}}, "required": []}}
