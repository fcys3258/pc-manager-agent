TOOL_DEF = {"name": "get_active_connections", "description": "获取活动网络连接列表", "input_schema": {"type": "object", "properties": {"limit": {"type": "integer"}, "sort_by": {"type": "string", "enum": ["local_port", "remote_port", "state", "none"]}}, "required": []}}
