TOOL_DEF = {"name": "move_file_to_recycle_bin", "description": "移动文件到回收站", "input_schema": {"type": "object", "properties": {"paths": {"anyOf": [{"type": "string"}, {"type": "array", "items": {"type": "string"}}]}}, "required": ["paths"]}}
