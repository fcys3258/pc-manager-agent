TOOL_DEF = {"name": "get_event_log", "description": "获取事件日志", "input_schema": {"type": "object", "properties": {"log_name": {"type": "string", "enum": ["System", "Application", "Security"]}, "level": {"type": "string"}, "event_id": {"type": "integer"}, "time_range_hours": {"type": "integer"}, "max_events": {"type": "integer"}}, "required": []}}
