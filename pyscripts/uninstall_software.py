TOOL_DEF = {"name": "uninstall_software", "description": "卸载软件", "input_schema": {"type": "object", "properties": {"name": {"type": "string"}, "uninstall_string": {"type": "string"}, "force_quiet": {"type": "boolean"}}, "required": []}}
