TOOL_DEF = {"name": "disable_startup_item", "description": "禁用启动项", "input_schema": {"type": "object", "properties": {"item_type": {"type": "string", "enum": ["REGISTRY", "TASK", "FOLDER"]}, "item_path": {"type": "string"}, "item_name": {"type": "string"}}, "required": ["item_type", "item_path", "item_name"]}}
