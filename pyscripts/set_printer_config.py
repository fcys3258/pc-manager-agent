TOOL_DEF = {"name": "set_printer_config", "description": "设置打印机配置", "input_schema": {"type": "object", "properties": {"printer_name": {"type": "string"}, "paper_size": {"type": "string"}, "color": {"type": "boolean"}, "duplex": {"type": "string"}}, "required": ["printer_name"]}}
