TOOL_DEF = {"name": "kill_process", "description": "终止进程", "input_schema": {"type": "object", "properties": {"pid": {"type": "integer"}, "process_key": {"type": "string"}, "force": {"type": "boolean"}, "kill_tree": {"type": "boolean"}}, "required": []}}
