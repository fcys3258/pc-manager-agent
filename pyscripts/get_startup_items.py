TOOL_DEF = {"name": "get_startup_items", "description": "获取启动项列表", "input_schema": {"type": "object", "properties": {"limit": {"type": "integer"}, "sort_by": {"type": "string", "enum": ["name", "publisher", "source"]}}, "required": []}}
