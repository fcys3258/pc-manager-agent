TOOL_DEF = {"name": "control_print_job", "description": "控制打印任务（暂停/恢复/重启）", "input_schema": {"type": "object", "properties": {"printer_name": {"type": "string"}, "job_id": {"type": "integer"}, "action": {"type": "string"}}, "required": ["printer_name", "job_id", "action"]}}
