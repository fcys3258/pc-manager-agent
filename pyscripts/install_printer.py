TOOL_DEF = {"name": "install_printer", "description": "安装打印机", "input_schema": {"type": "object", "properties": {"name": {"type": "string"}, "ipp_url": {"type": "string"}, "driver_name": {"type": "string"}}, "required": ["name", "ipp_url"]}}
