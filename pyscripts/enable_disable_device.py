TOOL_DEF = {"name": "enable_disable_device", "description": "启用或禁用设备", "input_schema": {"type": "object", "properties": {"pnp_device_id": {"type": "string"}, "action": {"type": "string", "enum": ["enable", "disable"]}}, "required": ["pnp_device_id", "action"]}}
